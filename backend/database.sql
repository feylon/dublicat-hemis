...
INSERT INTO teacher (email, login, password, firstname, brithday, address, parent_name) VALUES
    ...
    ('bekzod@example.com', 'bekzoduser', 'pass345', 'Bekzod', '1990-10-08', '789 Pine Rd', 'Zafar'),
    ('zafar@example.com', 'zafaruser', 'pass456', 'Zafar', '1975-12-25', '321 Birch Ln', 'Bekzod'),
    ('dilshod@example.com', 'dilshoduser', 'pass567', 'Dilshod', '1995-07-30', '654 Cedar Ct', 'Dilbar'),
    ('dilbar@example.com', 'dilbaruser', 'pass678', 'Dilbar', '1988-11-11', '987 Elm St', 'Dilshod'),
    ('shavkat@example.com', 'shavkatuser', 'pass789', 'Shavkat', '1983-03-18', '159 Walnut Blvd', 'Dilnoza'),
    ('dilnoza@example.com', 'dilnouser', 'pass890', 'Dilnoza', '1992-09-05', '753 Maple Dr', 'Shavkat'),
    ('umid@example.com', 'umiduser', 'pass901', 'Umid', '1987-06-22', '486 Spruce St', 'Farida'),
    ('farida@example.com', 'faridauser', 'pass012', 'Farida', '1993-04-10', '592 Fir Ave', 'Umid');

update teacher set password = '$2b$10$qszd/we2sPerBlHoeUKageRfkVnM9T5LUndqxhgli3NmJdTHRhbOG';
...
tuman_id integer,
foreign key (tuman_id) references  tuman (id));
insert into dean (email, login, password, firstname, brithday) values
